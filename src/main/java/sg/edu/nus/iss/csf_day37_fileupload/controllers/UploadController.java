...
import sg.edu.nus.iss.csf_day37_fileupload.repositories.S3Repository;
...
public class UploadController {
    ...
    @ResponseBody
    public ResponseEntity<String> postUploadReturnJson(@RequestPart String description, @RequestPart MultipartFile myfile){
        try {
